...
//
// `body.titled main h1` already carries live's page-heading component: 24px on 32px, stepping to 40px
// on 44px at 992, in the secondary family at weight 400.
//
// `ram-holidays-faq` and `children-and-pregnancy/children` are different. Read at 375, 768, 992 and
// 1440 on 2026-08-07: live draws an h1 in the primary family at a flat 40px on 48px, weight 500,
// #1a1717, and ours reads 32px on 38.4px with the same family, weight and colour. So only the size and
// the leading differ, and they do not step. 20 documents, ten markets each, and `theme:
// page-title-40` on each becomes the body class.
//
// The `holidays` family is not in this set. Live titles it as an h2 in the secondary family at
// rgb(230, 238, 250) on a dark banner, which is the white-on-a-banner class the heading-colour tokens
// leave out on purpose: a white rule with no banner puts white text on a white page.
